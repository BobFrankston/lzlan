...
class LifxLanUdp1 {
    ...
    * ---------------------------------------------------------------- */
    ...
    async discover(params) {
        ...
        await this._sendBroadcast(req_list);
        await lants_1.delayms(wait); // Wait to see that the cats drag in?
        const deviceArray = [];
...
LifxLanUdp1.created = false;
exports.LifxLanUdp1 = LifxLanUdp1;
class LifxLanUdp {
    constructor() {
        // Private
        this._UDP_PORT = 56700;
